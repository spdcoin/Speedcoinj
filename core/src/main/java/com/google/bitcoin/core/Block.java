...
public class Block extends Message {
    ...
    public BigInteger getBlockInflation(int height) {
        return Utils.toNanoCoins(25, 0).shiftRight(height / params.getSubsidyDecreaseBlockCount());
    }
	...
	*/
    ...
    public Block createNextBlock(Address to, long time) {
        return createNextBlock(to, null, time, EMPTY_BYTES, Utils.toNanoCoins(25, 0));
    }
    ...
    Block createNextBlock(@Nullable Address to, @Nullable TransactionOutPoint prevOut, long time,
        ...
        if (to != null) {
            ...
            t.addOutput(new TransactionOutput(params, t, Utils.toNanoCoins(25, 0), to));
    ...
    public Block createNextBlock(@Nullable Address to, TransactionOutPoint prevOut) {
        return createNextBlock(to, prevOut, Utils.now().getTime() / 1000, EMPTY_BYTES, Utils.toNanoCoins(25, 0));
    }
    ...
    public Block createNextBlock(@Nullable Address to) {
        return createNextBlock(to, Utils.toNanoCoins(25, 0));
    }
    ...
    Block createNextBlockWithCoinbase(byte[] pubKey) {
        return createNextBlock(null, null, Utils.now().getTime() / 1000, pubKey, Utils.toNanoCoins(25, 0));
    }
