...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis1(NetworkParameters n) {
        ...
        try {
            ...
            //scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
            t.addOutput(new TransactionOutput(n, t, Utils.toNanoCoins(25, 0), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
            throw new RuntimeException(e);
        }
    ...
    /** How many blocks pass between difficulty adjustment periods. Bitcoin standardises this to be 2017. */
